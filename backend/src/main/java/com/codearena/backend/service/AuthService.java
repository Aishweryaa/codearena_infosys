...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request) {
        ...
        return response("Registration successful", saved);
    }
    ...
    public AuthResponse login(LoginRequest request) {
        ...
        if (user.getPasswordHash() == null) {
            throw new InvalidCredentialsException("This account uses Google login");
        }
    ...
    public AuthResponse response(String message, User user) {
    ...
    private void createLeaderboardEntry(User user) {
